...
parser.add_argument('--results_path', type=str, default='./deconv_model/results/')
...
# load   
whole_model = torch.load(args.save_path + 'epoch_40_ckpt.pth.tar', map_location=torch.device('cuda' if cuda_is_present else 'cpu'))
